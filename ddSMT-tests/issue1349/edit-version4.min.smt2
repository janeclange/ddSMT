...
(assert (=> __ic3_ind_gen_152 (> _substvar_24_ 0)))
(declare-fun __ic3_ind_gen_153 () Bool)
(assert true)
(declare-fun __ic3_ind_gen_154 () Bool)
(assert true)
(declare-fun __ic3_ind_gen_155 () Bool)
(assert (=> __ic3_ind_gen_155 (> _substvar_17_ 0)))
(assert __ic3_ind_gen_155)
(assert true)
(assert true)
(assert (not (not (> _substvar_28_ 0))))
(assert true)
(assert true)
(push 1)
(check-sat)
(pop 1)
(assert (> _substvar_2_ 0))
(check-sat)
(get-unsat-core)
